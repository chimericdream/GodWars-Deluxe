...
char *format_obj_to_char(OBJ_DATA *obj, CHAR_DATA *ch, bool fShort)
{
    ...
    {
    if (IS_SET(obj->quest, QUEST_IMPROVED)) strcat(buf, "(Mythical) ");
    else strcat(buf, "(Legendary) ");
    }
    if (IS_SET(obj->quest, QUEST_BLOODAGONY)) strcat(buf, "(Bleeding) ");
...
void do_who(CHAR_DATA *ch, char *argument)
{
        ...
        wch->pcdata->chobj != NULL)
    {
        ...
        {
        default:    class = "An Object    ";    break;
        case 12:    class = "A Head       ";    break;
        case 30005:    class = "A Brain      ";    break;
        }
    }
    ...
    case MAX_LEVEL -  9:
        switch (wch->race)
        {
        default:    class = "Supreme God  ";    break;
        case 0:        class = "Avatar       ";    break;
        case 1: case 2: case 3: case 4:
                class = "Immortal     ";    break;
        case 5: case 6: case 7: case 8: case 9:
                class = "Godling      ";    break;
        case 10: case 11: case 12: case 13: case 14:
                class = "Demigod      ";    break;
        case 15: case 16: case 17: case 18: case 19:
                class = "Lesser God   ";    break;
        case 20: case 21: case 22: case 23: case 24:
                class = "Greater God  ";    break;
        }
        break;
    case MAX_LEVEL - 10:
    case MAX_LEVEL - 11:
